...
resource "aws_security_group" "k3s" {
  ...
  # ----------------------------------------------------------
  #
  # Accessible uniquement depuis le VPC.
  #
  # ----------------------------------------------------------
  ...
  #
  # Important :
  # NE PAS exposer 8472 à Internet.
  #
  # ----------------------------------------------------------
...
resource "aws_instance" "k3s" {
  ...
  #
  # Pour K3s + Prometheus + Grafana :
  # t4g.medium est fortement recommandé.
  #
  # ----------------------------------------------------------
...
# ============================================================
#
# IMPORTANT POUR t4g.small.
#
# Kubernetes préfère généralement ne pas utiliser le swap,
# mais sur une machine de 2 GiB avec Prometheus/Grafana,
# un swap de secours évite les OOM brutaux.
#
# ============================================================
...
if ! grep -q "KUBECONFIG=/home/ubuntu/.kube/config" \
  /home/ubuntu/.bashrc; then
...
# IMPORTANT :
#
# La configuration ci-dessous est volontairement légère.
#
# t4g.small = 2 GiB RAM.
#
# On limite :
